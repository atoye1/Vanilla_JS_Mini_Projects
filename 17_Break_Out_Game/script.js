...
4. Create bricks
5. Draw score
6. add update() - animate - requests animationFrame(cb)
7. Move paddle
...
function moveBall() {
    ...
    if (ball.x + ball.size > canvas.width || ball.x - ball.size < 0) {
        console.log("width collision");
        ball.dx *= -1;
        return;
    }
    // Wall collision up, down
    if (ball.y - ball.size < 0 || ball.y + ball.size > canvas.height) {
        console.log("hight collision");
        ball.dy *= -1;
        return;
    }
...
// rulse and close event handlers
